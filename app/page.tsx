      ...
      <section className="contact section-pad" id="contacto">
        <div className="contact-copy">
          ...
          <div className="contact-methods">
            ...
            <a
              className="whatsapp-contact-method"
              href="https://wa.me/525543501601?text=Hola%20Zenttre%2C%20quiero%20solicitar%20una%20cotizaci%C3%B3n."
              target="_blank"
              rel="noreferrer"
            ...
            >
              <div>
                ...
                <svg className="whatsapp-contact-icon" viewBox="0 0 32 32" aria-hidden="true">
