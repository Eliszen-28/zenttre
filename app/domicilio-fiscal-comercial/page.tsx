...
export default function DomicilioFiscalComercialPage() {
  return (
    <ServiceDetailPage
      ...
      footnotes={["*6% de descuento al hacer tu pago semestral.", "*12% de descuento al hacer tu pago anual.", "Servicio adicional de número telefónico personalizado:", "Activación por $1,000.00 + I.V.A.", "Pago mensual de $500.00 + I.V.A."]}
